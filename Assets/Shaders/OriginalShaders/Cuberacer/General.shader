...
Shader "Cuberacer/General"
{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha addshadow fullforwardshadows noambient nolightmap nofog nolppv
		#pragma target 3.0
